          ...
          <section id="header" className={styles.header}>
            <div className={styles.left}>
              ...
              <p
                ...
                data-aos-duration="500"
              >
                I took it as a passion right from the Genesis. A Young Nigerian
              ...
              >
                <a style={{color:'black', textDecoration:"none"}} href="https://instagram.com/_pysavant.codes">Let's chew the fat!! 🤝</a>
              </motion.div>
            </div>
...
<spline-viewer url="https://prod.spline.design/Akh2azdiuUYopsRW/scene.splinecode"></spline-viewer>
          ...
          <section id="about" className={styles.about}>
            ...
            <div className={styles.content}>
              ...
              >
                <p>
                  Hey, I'm Pysavant and I've been obsessed with tech since I was
                  very young. I love using technology to tackle complex problems
                  and make life better for people. With a keen eye for detail
                  and a creative mindset, I'm always looking for new ways to use
                  tech to change the game.
                  <br />
                  <br />
                  Fast-forward to today, I’ve had the privilege of working as a
                  freelancer on various start-ups and corporations. My goal is
                  to make a positive impact on the world and contribute to the
                  ever-evolving tech scenes 😀.
                </p>
          ...
          <section id="footer" className={styles.footer}>
            ...
            >
              <h1>Get In Touch</h1>
              <p>
                Thanks for taking the time to visit my website. If you have any
                questions, comments, or just want to say hello, I'd love to hear
                from you. I'll do my best to get back to you as soon as
        ...
        <script type="module"  src="https://unpkg.com/@splinetool/viewer@0.9.281/build/spline-viewer.js"></script>
